...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-2 offset-6"><a href="{{ url('/') }}" role="button" class="btn btn-info">
                    < Volver</a>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('editar_trabajador') }}" method="post" id="submit">
                                ...
                                <p>Grupo: <input type="number" class="editar" id="grupo" name="grupo" min="0"></p>
                                ...
                                <p style="color: red" hidden id="erroreditar">!Algunos de los campos estan vacios, reviselos
                                    por
                                    favor!</p>
                            </form>
                        </div>
