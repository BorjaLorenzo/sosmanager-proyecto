...
@section('content')
    @if ($usuario[0]->rol == '')
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="alert alert-warning" role="alert">Tu registro esta siendo verificado por un ADMINISTRADOR,
                        cuando sea confirmado podras empezar a usar nuestros servicios!</p>
                </div>
            </div>
        </div>
    @else
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <h2>Plantilla Trabajadores</h2>
                </div>
                <div class="col-3 offset-5">
                    @if ($rol == 'A')
                    <a href="{{ url('/nuevos_trabajadores') }}" role="button" class="btn btn-success">
                        Nuevos registros</a>
                    @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer" id="exampleModalLabel">
                                <form action="{{ url('eliminar_trabajador') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="dni_eliminar" id="dni_eliminar">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('editar_trabajador') }}" method="post" id="submit">
                                    @csrf
                                    <p>Nombre: <input type="text" class="editar" id="nombre" name="nombre"></p>
                                    {{-- <p>Apellidos: <input type="text" name="apellidos" id="apellidos"></p> --}}
                                    <p>DNI: <input type="text" class="editar" id="dni" name="dni"></p>
                                    <input type="hidden" name="old_dni" id="old_dni">
                                    <p>Grupo: <input type="number" class="editar" id="grupo" name="grupo" min="0">
                                    </p>
                                    ...
                                    <p>Asuntos propios disponibles: <label class="switch">
                                            <input type="checkbox" id="asuntos" name="asuntos">
                                            <span class="slider round"></span>
                                        </label></p>
                                    <p style="color: red" hidden id="erroreditar">!Algunos de los campos estan vacios,
                                        reviselos
                                        por
                                        favor!</p>
                                </form>
